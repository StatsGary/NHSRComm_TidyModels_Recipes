...
The aim of this webinar is to provide you with a classification model that you can build from scratch. 
...
In a previous course doing an overview of CARET. I created an add-in that is being shipped with this webinar as well:
```{r cm_visual}
source("Functions/confusion_matrix_plot_function.R") #Get the addin functions
